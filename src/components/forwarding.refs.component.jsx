...
/**react-design-patterns-app - version 8.02 - ForwardingRefs 
 * - Features: 
 * 
 *     --> Adding 'ingrefinputcode' code 
 * 
    ...
    return(
        ...
        <SectionWrapper>
            ...
            <p>
                ...
                <span className="text-white font-semibold"> IngRefInput </span>, i use the hook: 
            </p>
