...
/**react-design-patterns-app - version 2.13 - components > index  
 * - Features: 
 * 
 *     --> Importing and exporting 'RegularList'
 * 
 * Note: Pending to make responsive design
 */

export { LayoutComponentPattern, SharedLayout, CustomTitle, IntroComponent, SplitScreen, SplitScreenVariation, BashCode, RegularList}