...
import BooksSmallListItems from "./books.small.items.component";
import LeftSideComponent from "./left.side.prop.component";
...
export { LeftSideComponent,
         RightSideComponent,
         LeftSideComponentVariation,
