...
/**react-design-patterns-app - version 52.02 - styled.components
 * - Features: 
 * 
 *     --> Refactoring 'StyledListIngredient'  styles   
 * 
...
export const SearchLabelDebounce = styled.label`
	${tw`text-lg font-bold text-yellow-400`}	
`

export const SearchFormDebounce = styled.form`
...
export const SearchItem = styled.li`
	${tw`p-2 my-1 bg-gray-700 rounded-md transition duration-300 cursor-pointer hover:bg-gray-600`}	
`
...
export const SearchInput = styled.input`
	${tw`w-4/5 p-4 text-base border-2 border-yellow-400 rounded-md bg-gray-800 text-white outline-none placeholder-gray-400`}	
`
...
export const StyledListIngredient = styled.ul`
	${tw`border-t border-solid border-gray-300`}		
`;

export const StyledContainerIngredient = styled.div`
	text-align: left;
`;

export const StyledButtonIngredient = styled.button`
	width: 1.25rem;
	height: 1.25rem;
	border: 0;
...
export const StyledButtonContainerIngredients = styled.div`
	display: flex;
...
export const StyledHeadingIngredients = styled.h2`
	margin-bottom: 1rem;
	font-weight: 600;
`;
...
export const AppContainerOptimized = styled.div`
...
export const HeadingNavigation = styled.h1`
	${tw`font-semibold text-2xl`}	
...
export const StyledInputImmer = styled.input`
...
export const StyledAddItemContainerImmer = styled.div`
	${tw`flex flex-col justify-end gap-2 `}
...
export const StyledButtonReducer = styled.button`
	${tw`self-end px-4 py-2 bg-white text-[#1a472a] w-1/3 text-lg font-semibold hover:bg-white hover:text-blue-900 hover:rounded-lg hover:border hover:border-orange-500`}
...
export const StyledLabelReducer = styled.label`
	${tw`mb-2 text-yellow-200 text-xl`}
...
export const ContentImmer = styled.div`
	${tw`flex gap-4 overflow-x-auto pl-[25px] bg-[#3b3d97]`}
...
.trottling-rendering-optimization{
	span{
		${tw`text-red-500 underline`}
		}	
}

.use-reducer-hook-patterns{
	span{
			${tw`text-indigo-500 underline`}
		}	
}

.lazy-and-code-splitting-performance{
	span{
			${tw`text-indigo-500 underline`}
		}
}
